...
# callbacks
checkpoint = ModelCheckpoint("efficientnetb0_best.h5", monitor="val_accuracy",
...
plt.legend()
plt.grid(True)
plt.savefig("efficientnetb0_accuracy_curve.png", bbox_inches="tight")
plt.show()
...
plt.tight_layout()
plt.savefig("efficientnetb0_confusion.png", bbox_inches="tight")
plt.show()
